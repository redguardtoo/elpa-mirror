...
* Why
- The only way to got a setup never breaks
...
Installation is optional, you can runing =elpa-mirror.el= directly as a independent script. Check the section "Tips".
* Usage
